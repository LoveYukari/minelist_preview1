...
{
  updateItemPage({Key key,this.title,this.updateItem}):super(key:key);
  final String title;
  final json_itemInfo updateItem;
  @override
                      ...
                      child:Column(
                        ...
                        children: <Widget>[
                          ...
                          TextFormField(textCapitalization: TextCapitalization.words,
                            ...
                            //initialValue: widget.updateItem.itemName,
                          ...
                          TextFormField(textCapitalization: TextCapitalization.words,
                            ...
                            //initialValue: widget.updateItem.itemCategory,
                            decoration: const InputDecoration(
                              border: UnderlineInputBorder(),
                              filled: true,
                          ...
                          TextFormField(textCapitalization: TextCapitalization.words,
                            ...
                            //initialValue: widget.updateItem.modName,
                            decoration: const InputDecoration(
                              border: UnderlineInputBorder(),
                              filled: true,
                          ...
                          TextFormField(textCapitalization: TextCapitalization.words,
                            ...
                            //initialValue: widget.updateItem.commentInfo,
                            decoration: const InputDecoration(
                          ...
                          RaisedButton(
                            onPressed: ()async
                            {
                              json_itemInfo item = new json_itemInfo(
                                  itemID:widget.updateItem.itemID,
                                  itemName:myController1.text,
                                  itemCategory: myController2.text,
                                  commentInfo: myController4.text,
                                  base64encTexture: pics,
                                  createTime: "",
                                  lastUpdateTime: "",
                                  modName: myController3.text
                              );
                              if(item.itemName==""||item.itemCategory==""||item.modName==""||item.base64encTexture==null){
                              ...
                              {
                                var resp = await NetworkUtil.updateItem(item);
                                if(resp=="Success")
                                {
                                  showDialog(context: context,builder: (BuildContext context){
                                    return AlertDialog(
                                        ...
                                        actions:[FlatButton(child: Text("OK"),onPressed:(){Navigator.pop(context);Navigator.pop(context);Navigator.pop(context);}),]
                                    );
                                  });
                                }else
                                {
                            ...
                            child:new Text("UPDATE!",style:new TextStyle(fontSize: 20,color: Colors.white),),
                            color: Colors.green,
